...
public class InvokeLaunchTestScenarioThread extends AbstractClientInvokerThread {

	public InvokeLaunchTestScenarioThread(ClientInformation clientInformation,
	...
	public String getURL() {
		return "/LaunchTestScenariosSvc/execute";
	}
}
