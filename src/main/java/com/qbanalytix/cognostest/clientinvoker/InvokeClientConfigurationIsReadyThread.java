...
public class InvokeClientConfigurationIsReadyThread extends AbstractClientInvokerThread {

	public InvokeClientConfigurationIsReadyThread(ClientInformation clientInformation,
	...
	public String getURL() {
		return "/ClientConfigurationSvc/isReady";
	}
}
